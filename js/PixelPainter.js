window.onload = function() {
  ...
  var colorPalette = new pxlPainter.createGrid(6,6, 'colorPalette', 'color');
  var mainGrid = new pxlPainter.createGrid(15, 15, 'mainGrid', 'grid');
...
var GridMaker = function() {
  ...
  var createGrid = function(x, y, id, type) {
    //sets divEl equal to pixelPainter div
    var divEl = document.getElementById(type + 'Container');
    console.log(divEl);
  ...
  var eraseButton = function() {
    var cPalette = document.getElementById('colorPalette')
    var button = document.createElement('button');
    button.setAttribute('id', 'erase');
    button.innerHTML = 'erase';
    cPalette.appendChild(button);
